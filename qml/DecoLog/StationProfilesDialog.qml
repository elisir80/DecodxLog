// DecoLog — profili stazione (mockup 1d): elenco a sinistra, scheda a destra.
        ...
        ColumnLayout {
            ...
            ListView {
                ...
                Text {
                    ...
                    text: qsTr("No profiles yet. Create one, or start Decodium: DecoLog creates the first from its callsign and grid.")
                    color: Theme.textSecondary
                    font.pixelSize: 11
                }
            }
