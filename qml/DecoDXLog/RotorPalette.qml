// DecoDXLog — i colori del posto di comando DecoRotor.
//
// Sono quelli di `desktop/qml/DecoRotor/Theme.qml`, copiati tali e quali: la
// finestra del rotore dentro DecoDXLog deve essere il programma che l'operatore
// gia' conosce, non una sua imitazione con altre tinte. Non e' un singleton per
// non litigare con il tema di DecoDXLog: ogni componente se ne tiene una copia,
