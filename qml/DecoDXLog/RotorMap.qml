// DecoDXLog — la mappa satellitare sotto il quadrante, come nel posto di comando.
//
...
// gli spot del cluster di DecoDXLog, ognuno con la sua rotta dal QTH; toccarne uno
// porta l'antenna li' sopra.
// Copia di `desktop/qml/DecoRotor/SatelliteMap.qml`, con gli spot di DecoDXLog.
import QtQuick
...
Item {
    ...
    Plugin {
        ...
        PluginParameter {
            name: "osm.useragent"
            value: "DecoDXLog/DecoRotor (rotore d'antenna amatoriale)"
        }
