...
// DecoDXLog: la libreria stampava il decodificato su stdout mentre decodifica.
// Noi lo leggiamo con takeRxData(), e un programma con la finestra non ha un
// terminale dove stamparlo: con GGMORSE_QUIET le due stampe non ci sono.
#ifdef GGMORSE_QUIET
#  define GGMORSE_PRINT(...) ((void) 0)
#  define GGMORSE_FLUSH()    ((void) 0)
#else
#  define GGMORSE_PRINT(...) printf(__VA_ARGS__)
#  define GGMORSE_FLUSH()    fflush(stdout)
#endif
